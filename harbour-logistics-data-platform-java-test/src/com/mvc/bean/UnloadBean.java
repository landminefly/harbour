...
public class UnloadBean {
    ...
    public UnloadBean(int id, String ship_company, String ship_name, Timestamp start_time, Timestamp end_time, Timestamp departure_time, Timestamp arrival_time, String port, String lading_number, String container_number, String container_size, String departure, String destination) {
        this.id = id;
